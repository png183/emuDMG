...
void SM83::instruction() {
  ...
  case 0x34: cycleWrite(HL(), INC(cycleRead(HL()))); return;  // INC (HL)
  case 0x35: cycleWrite(HL(), DEC(cycleRead(HL()))); return;  // DEC (HL)
  case 0x36: cycleWrite(HL(), fetch8());             return;  // LD (HL),n
  ...
  case 0x46: b = cycleRead(HL()); return;  // LD B,(HL)
  ...
  case 0x4e: c = cycleRead(HL()); return;  // LD C,(HL)
  ...
  case 0x56: d = cycleRead(HL()); return;  // LD D,(HL)
  ...
  case 0x5e: e = cycleRead(HL()); return;  // LD E,(HL)
  ...
  case 0x66: h = cycleRead(HL()); return;  // LD H,(HL)
  ...
  case 0x6e: l = cycleRead(HL()); return;  // LD L,(HL)
  case 0x6f: l = a;               return;  // LD L,A
  case 0x70: cycleWrite(HL(), b); return;  // LD (HL),B
  case 0x71: cycleWrite(HL(), c); return;  // LD (HL),C
  case 0x72: cycleWrite(HL(), d); return;  // LD (HL),D
  case 0x73: cycleWrite(HL(), e); return;  // LD (HL),E
  case 0x74: cycleWrite(HL(), h); return;  // LD (HL),H
  case 0x75: cycleWrite(HL(), l); return;  // LD (HL),L
  case 0x76: HALT();              return;  // HALT
  case 0x77: cycleWrite(HL(), a); return;  // LD (HL),A
  ...
  case 0x7e: a = cycleRead(HL()); return;  // LD A,(HL)
  ...
  case 0x86: ADD(cycleRead(HL())); return;  // ADD (HL)
  ...
  case 0x8e: ADC(cycleRead(HL())); return;  // ADC (HL)
  ...
  case 0x96: SUB(cycleRead(HL())); return;  // SUB (HL)
  ...
  case 0x9e: SBC(cycleRead(HL())); return;  // SBC (HL)
  ...
  case 0xa6: AND(cycleRead(HL())); return;  // AND (HL)
  ...
  case 0xae: XOR(cycleRead(HL())); return;  // XOR (HL)
  ...
  case 0xb6: OR(cycleRead(HL()));  return;  // OR (HL)
  ...
  case 0xbe: CP(cycleRead(HL()));  return;  // CP (HL)
...
void SM83::instructionCB() {
  ...
  case 0x06: cycleWrite(HL(), RLC(cycleRead(HL())));  return;  // RLC (HL)
  ...
  case 0x0e: cycleWrite(HL(), RRC(cycleRead(HL())));  return;  // RRC (HL)
  ...
  case 0x16: cycleWrite(HL(), RL(cycleRead(HL())));   return;  // RL (HL)
  ...
  case 0x1e: cycleWrite(HL(), RR(cycleRead(HL())));   return;  // RL (HL)
  ...
  case 0x26: cycleWrite(HL(), SLA(cycleRead(HL())));  return;  // SLA (HL)
  ...
  case 0x2e: cycleWrite(HL(), SRA(cycleRead(HL())));  return;  // SRA (HL)
  ...
  case 0x36: cycleWrite(HL(), SWAP(cycleRead(HL()))); return;  // SWAP (HL)
  ...
  case 0x3e: cycleWrite(HL(), SRL(cycleRead(HL())));  return;  // SRL (HL)
  ...
  case 0x46: BIT(0, cycleRead(HL())); return;  // BIT 0,(HL)
  ...
  case 0x4e: BIT(1, cycleRead(HL())); return;  // BIT 1,(HL)
  ...
  case 0x56: BIT(2, cycleRead(HL())); return;  // BIT 2,(HL)
  ...
  case 0x5e: BIT(3, cycleRead(HL())); return;  // BIT 3,(HL)
  ...
  case 0x66: BIT(4, cycleRead(HL())); return;  // BIT 4,(HL)
  ...
  case 0x6e: BIT(5, cycleRead(HL())); return;  // BIT 5,(HL)
  ...
  case 0x76: BIT(6, cycleRead(HL())); return;  // BIT 6,(HL)
  ...
  case 0x7e: BIT(7, cycleRead(HL())); return;  // BIT 7,(HL)
  ...
  case 0x86: cycleWrite(HL(), RES(0, cycleRead(HL()))); return;  // RES 0,(HL)
  ...
  case 0x8e: cycleWrite(HL(), RES(1, cycleRead(HL()))); return;  // RES 1,(HL)
  ...
  case 0x96: cycleWrite(HL(), RES(2, cycleRead(HL()))); return;  // RES 2,(HL)
  ...
  case 0x9e: cycleWrite(HL(), RES(3, cycleRead(HL()))); return;  // RES 3,(HL)
  ...
  case 0xa6: cycleWrite(HL(), RES(4, cycleRead(HL()))); return;  // RES 4,(HL)
  ...
  case 0xae: cycleWrite(HL(), RES(5, cycleRead(HL()))); return;  // RES 5,(HL)
  ...
  case 0xb6: cycleWrite(HL(), RES(6, cycleRead(HL()))); return;  // RES 6,(HL)
  ...
  case 0xbe: cycleWrite(HL(), RES(7, cycleRead(HL()))); return;  // RES 7,(HL)
  ...
  case 0xc6: cycleWrite(HL(), SET(0, cycleRead(HL()))); return;  // SET 0,(HL)
  ...
  case 0xce: cycleWrite(HL(), SET(1, cycleRead(HL()))); return;  // SET 1,(HL)
  ...
  case 0xd6: cycleWrite(HL(), SET(2, cycleRead(HL()))); return;  // SET 2,(HL)
  ...
  case 0xde: cycleWrite(HL(), SET(3, cycleRead(HL()))); return;  // SET 3,(HL)
  ...
  case 0xe6: cycleWrite(HL(), SET(4, cycleRead(HL()))); return;  // SET 4,(HL)
  ...
  case 0xee: cycleWrite(HL(), SET(5, cycleRead(HL()))); return;  // SET 5,(HL)
  ...
  case 0xf6: cycleWrite(HL(), SET(6, cycleRead(HL()))); return;  // SET 6,(HL)
  ...
  case 0xfe: cycleWrite(HL(), SET(7, cycleRead(HL()))); return;  // SET 7,(HL)
